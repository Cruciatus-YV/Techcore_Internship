...
public class BooksController : ControllerBase
{
    ...
    public async Task<IActionResult> GetByAuthorId([FromRoute] Guid authorId, CancellationToken cancellationToken)
    {
        var books = await _bookService.GetByAuthorIdAsync(authorId, cancellationToken);
        return Ok(books ?? new List<BookResponseDto>());
    }
    ...
    public async Task<IActionResult> GetAllWithAuthors(CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> GetByYear([FromRoute] int year, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> CreateWithAuthors([FromBody] CreateBookWithAuthorsRequestDto request, CancellationToken cancellationToken)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update([FromRoute] Guid id, [FromBody] UpdateBookRequestDto request, CancellationToken cancellationToken)
    {
    ...
    /// <returns>200 OK при успешном обновлении, 404 Not Found если книга не найдена</returns>
    [HttpPut("{id}/authors")]
    public async Task<IActionResult> UpdateAuthors([FromRoute] Guid id, [FromBody] UpdateBookAuthorsRequestDto request, CancellationToken cancellationToken)
    {
    ...
    /// <returns>200 OK при успешном обновлении, 404 Not Found если книга не найдена</returns>
    [HttpPut("{id}/info")]
    public async Task<IActionResult> UpdateBookInfo([FromRoute] Guid id, [FromBody] UpdateBookInfoRequestDto request, CancellationToken cancellationToken)
    {
    ...
    /// <returns>200 OK при успешном обновлении, 404 Not Found если книга не найдена</returns>
    [HttpPatch("{id}/title")]
    public async Task<IActionResult> UpdateTitle([FromRoute] Guid id, [FromBody] string title, CancellationToken cancellationToken)
    {
    ...
    /// <returns>200 OK при успешном обновлении, 404 Not Found если книга не найдена</returns>
    [HttpPatch("{id}/year")]
    public async Task<IActionResult> UpdateYear([FromRoute] Guid id, [FromBody] int year, CancellationToken cancellationToken)
    {
    ...
    [HttpGet("{id}/exists")]
    public async Task<IActionResult> Exists([FromRoute] Guid id, CancellationToken cancellationToken)
    {
